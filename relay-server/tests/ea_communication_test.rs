...
async fn test_request_config_slave_ea() {
    ...
    client.send_request_config("TEST_SLAVE_001", "Slave").unwrap();
...
async fn test_request_config_master_ea_rejected() {
    ...
    client.send_request_config("TEST_MASTER_001", "Master").unwrap();
...
async fn test_heartbeat_auto_registration() {
    ...
    client.send_heartbeat("TEST_AUTO_REG_001", "Master").unwrap();
