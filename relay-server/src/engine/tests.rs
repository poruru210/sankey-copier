...
fn test_should_copy_trade_allowed_symbols() {
    ...
    let signal = create_test_signal();
    let mut settings = create_test_settings();
    settings.filters.allowed_symbols = Some(vec!["EURUSD".to_string(), "GBPUSD".to_string()]);
...
fn test_should_copy_trade_symbol_not_allowed() {
    ...
    let signal = create_test_signal();
    let mut settings = create_test_settings();
    settings.filters.allowed_symbols = Some(vec!["GBPUSD".to_string()]);
...
fn test_should_copy_trade_blocked_symbols() {
    ...
    let signal = create_test_signal();
    let mut settings = create_test_settings();
    settings.filters.blocked_symbols = Some(vec!["EURUSD".to_string()]);
...
fn test_should_copy_trade_allowed_magic_numbers() {
    ...
    let signal = create_test_signal();
    let mut settings = create_test_settings();
    settings.filters.allowed_magic_numbers = Some(vec![0, 123]);
...
fn test_should_copy_trade_magic_not_allowed() {
    ...
    let signal = create_test_signal();
    let mut settings = create_test_settings();
    settings.filters.allowed_magic_numbers = Some(vec![123, 456]);
...
fn test_should_copy_trade_blocked_magic_numbers() {
    ...
    let signal = create_test_signal();
    let mut settings = create_test_settings();
    settings.filters.blocked_magic_numbers = Some(vec![0]);
