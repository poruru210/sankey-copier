...
impl MtInstaller {
    ...
    fn install_config(&self, mql_path: &Path, resolved_ports: &ResolvedPorts) -> Result<()> {
        ...
        let ini_content = format!(
            r#"# SANKEY Copier Configuration
# Auto-generated by relay-server installer
# Do not edit manually - use web-ui to reinstall if ports change
...
mod tests {
    ...
    fn test_install_config() {
        ...
        assert!(content.contains("ConfigSenderPort=15557"));
    }

    /// Helper function to create test ResolvedPorts
