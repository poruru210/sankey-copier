// Drawer component for mobile-first bottom sheet
// Based on Vaul library for mobile-optimized drawer interactions
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        side === 'left' && 'inset-y-0 left-0 mr-24 w-auto rounded-r-[10px]',
        side === 'right' && 'inset-y-0 right-0 ml-24 w-auto rounded-l-[10px]',
        className
      )}
      {...props}
    >
